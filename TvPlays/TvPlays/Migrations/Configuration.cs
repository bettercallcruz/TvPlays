namespace TvPlays.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TvPlays.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TvPlays.Models.ApplicationDbContext context)
        {
            ...
            {
                new Clips {ID=1, DateClip=new DateTime(1996, 5, 24, 12, 0, 0), TitleClip="Biggest Play on Rocket League", PathClip="/biggestplay.mp4", UtilizadoresFK=1, TimeClip= new TimeSpan(00, 4, 33)},
                new Clips {ID=2, DateClip=new DateTime(1996, 5, 24, 12, 0, 0), TitleClip="Anuncio TvPlays", PathClip="/TvPlaysAD.mp4", UtilizadoresFK=1, TimeClip= new TimeSpan(00, 3, 05)},
                new Clips {ID=3, DateClip=new DateTime(1996, 5, 24, 12, 0, 0), TitleClip="Avaliem o meu jogo", PathClip="/rocketReview.mp4", UtilizadoresFK=1, TimeClip= new TimeSpan(00, 5, 10)},
                new Clips {ID=4, DateClip=new DateTime(1996, 5, 24, 12, 0, 0), TitleClip="BIG AWP SHOT by ZorlaRusky", PathClip="/bigshotRusky.mp4", UtilizadoresFK=1, TimeClip= new TimeSpan(00, 2, 45)}
            };
